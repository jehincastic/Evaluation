    ...
    return(
        <div>
            ...
            <div>
                ...
                <br></br>
                <h2 className="f4-ns tc fw6 textName">{`${props.user.name.toUpperCase()}`}</h2>
                <br></br>
                <div className="mw9 ph3-ns">
                    <div className="cf tc ph2-ns push">
                        <a onClick={() => props.onRouteChange("resetPassword")} className="f4 link dim ph4 pv3 mb3 dib white bg-red btnedit" href="#0">Reset Password</a>                        
                    </div>
                </div>
            </div>
            <div>
